...
import com.bjfu.mcs.map.overlayutil.OverlayManager;
import com.bjfu.mcs.map.overlayutil.TransitRouteOverlay;
import com.bjfu.mcs.map.overlayutil.WalkingRouteOverlay;
...
public class RoutePlanDemo extends AppCompatActivity implements BaiduMap.OnMapClickListener,
    ...
    private RoutePlanDemo mContext;
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("路线规划功能");
