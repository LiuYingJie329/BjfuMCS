...
import com.bjfu.mcs.map.BDInnerNaviActivity;
import com.bjfu.mcs.map.customs.NaviSelectDialog;
...
import static com.bjfu.mcs.application.MCSApplication.APP_FOLDER_NAME;
import static com.bjfu.mcs.application.MCSApplication.mSDCardPath;
...
public class NavUtil {
    ...
    public static void showChoiceNaviWayDialog(final Activity activity, final LatLng startLL, final LatLng endLL, final String start_place, final String destination) {
        ...
        if (MapUtils.hasApp(activity, MapUtils.APP_BAIDU_MAP)) {
            mapApps.add(activity.getString(R.string.baidu_navi));
        }
        if (MapUtils.hasApp(activity, MapUtils.APP_AMAP)) {
