...
import com.bjfu.mcs.activity.SetPlaceActivity;
import com.bjfu.mcs.map.overlayutil.PoiOverlay;
...
public class PoiSearchDemo extends AppCompatActivity implements
    ...
    private PoiSearchDemo mContext;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("地图参与");
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            ...
            bundle.putString("search",keyWorldsView.getText().toString());
            bundle.putString("address",result.getAddress());
            bundle.putString("name",result.getName());
            bundle.putString("longitude",result.getLocation().longitude+"");
            bundle.putString("latitude",result.getLocation().latitude+"");
            RxActivityTool.skipActivity(mContext, SetPlaceActivity.class,bundle);
        }
    }
