...
public class LocationService extends Service {
    ...
    private MapDetailsDao mapDao = MCSApplication.getApplication().getDaoInstance().getMapDetailsDao();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        locationService = ((MCSApplication) getApplication()).locationService;
