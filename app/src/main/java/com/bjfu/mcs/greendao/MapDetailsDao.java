...
/** 
 * DAO for table "MAP_DETAILS".
*/
public class MapDetailsDao extends AbstractDao<MapDetails, Long> {

    public static final String TABLENAME = "MAP_DETAILS";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_DETAILS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_DETAILS\"";
        db.execSQL(sql);
    }
