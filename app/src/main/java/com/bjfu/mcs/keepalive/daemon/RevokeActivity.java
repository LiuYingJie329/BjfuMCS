package com.bjfu.mcs.keepalive.daemon;
            ...
            try {
                ...
                pm.getInstalledPackages(PackageManager.GET_PERMISSIONS)
                  ...
                  .forEach(i -> {
                      ...
                      if (shouldDisableBootCompletedOp()) {
                          try {
                              setModeMethod.invoke(aom, 66, uid, n, WHITE_LIST_APPS.contains(n) ? AppOpsManager.MODE_ALLOWED : AppOpsManager.MODE_IGNORED);
                          } catch (Exception e) {
                              e.printStackTrace();
                          }
                      }
