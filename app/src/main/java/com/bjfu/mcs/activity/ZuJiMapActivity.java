...
public class ZuJiMapActivity extends AppCompatActivity implements BaiduMap.OnMarkerClickListener,BaiduMap.OnMapClickListener{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("足迹地图");
    ...
    private void queryData(){
        if(!TextUtils.equals("yes",appcache.getAsString("isUploadLocation"))){
            return;
        }
    ...
    private void addLocation(List<LocationInfo> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            //定义Maker坐标点
            LatLng point = new LatLng(Double.parseDouble(location.getLatitude()), Double.parseDouble(location.getLongTitude()));
            //构建Marker图标
            ...
            if(i == 0){
                lastLocation = new LatLng(Double.parseDouble(location.getLatitude()), Double.parseDouble(location.getLongTitude()));
            }
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        tvLocation.setText(location.getAddressStr());
    ...
    public class LocationChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ACTION_LOCATION_CHANGE)) {
                String currLatitude = appcache.getAsString("lat");
                String currLontitude = appcache.getAsString("lon");
